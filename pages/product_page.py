...
class ProductPage(BasePage):
    ...
    def should_not_be_success_message(self):
        assert self.is_not_element_presented(
            *ProductPageLocators.INFO_PRODUCT_ADD), "Oops, message located, but should not be!"

    def should_be_message_is_disappeared(self):
        assert self.is_disappeared(
            *ProductPageLocators.INFO_PRODUCT_ADD), "Oops, message located, but should be disappeared!"
